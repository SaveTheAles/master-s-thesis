...
Готовность малой части информационного общества к персональной ответственности за безопасность своих данных хорошо продемонстрировало бурное развитие технологии блокчейн, в частности, где финансовые отношения происходят в одноранговой сети. Консистентность данных подтверждается алгоритмами консенсуса между участниками, что делает популярные атаки на достаточно развитую сеть очень дорогими для исполнения.

Концепт, который позволит продемонстрировать преимущество работы в одноранговой сети, даже с существенной потерей качества для пользователя, с точки зрения полного контроля пользовательских данных самим пользователем.
...
1. Разработать концепцию децентрализованной организации для работы над поставленной целью. Членами данной организации должны выступать представители заинтересованного сообщества. Отношения между членами организации должно быть прописано в соглашении децентрализованной организации и подписано членами организации личными криптографическими ключами в оговоренной заранее открытой для чтения системе.
2. Разработать соглашение между членами децентрализованной организации, в котором будут учтены цели, задачи, ценности, процедуры добавления и выхода бенефициаров / членов организации, процедуры распределения ценностей полученных извне, процедура ликвидации, функции, а также создание новой децентрализованной организации как ответвление от текущей.
3. Собрать первичную команду в качестве первых членов децентрализованной организации.
...
Обоснование первоочередного создания децентрализованной организации заключается в необходимости уменьшить контроль малой группы лиц над проектом. Это строгое условие регламентировано необходимостью органического роста проекта силами сообщества, где путь до желаемого результата будет указан вектором, заданным конечными потребителями.

Опыт подобных (linux, bitcoin) проектов показал главным критерием успешности децентрализованной организации способность продолжать существование и развитие вне зависимости от присутствия или отсутствия инициаторов данной организации.

## Выводы

В первую очередь названый концепт ориентирован на лишь малую часть современного сообщества сети Интернет. Речь идет о пользователях, которых интересует безопасность персональных данных, минимизация использования их третьими лицами, а также неприкосновенность частной жизни. Подобного рода проекты на данном этапе скорее всего не будут поддерживаться крупным бизнесом, в силу отсутствия явных критериев окупаемости, однако будут поддерживаться сообществом интернет пользователей как целевой аудиторией. Особое внимание стоит обратить на создание децентрализованной организации с тщательно продуманными соглашением и стартовой командой, потому как это в первое время данная организация будет единственным двигателем доставки концепта.
